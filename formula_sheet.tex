...
\begin{gather}
\frac{\mu_{bound}}{kT}=\bigg(\frac{\partial (F/kT)}{\partial N}\bigg)_{A,T} \tag{.} \\
=\ln{\bigg(\frac{N}{A-N} \bigg)}+\frac{w}{kT}-\ln{q_{bound}} \tag{.} \\ 
\ln{\bigg(\frac{\theta}{1-\theta} \bigg)}+\frac{w}{kT}-\ln{q_{bound}} \tag{27.7}
\end{gather}
